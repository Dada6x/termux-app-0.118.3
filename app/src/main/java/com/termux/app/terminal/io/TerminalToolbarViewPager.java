...
public class TerminalToolbarViewPager {
    ...
    public static class PageAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup collection, int position) {
            ...
            View layout;
            if (position == 0) {
                if (DeviceUtils.isWatchDevice(mActivity)) {
                    // Wear OS: use the looping carousel extra keys view so keys can be swiped
                    // in an infinite loop and are comfortable to press on the small screen.
                    layout = inflater.inflate(R.layout.view_terminal_toolbar_wear_extra_keys, collection, false);
                    WearLoopingExtraKeysView extraKeysView = (WearLoopingExtraKeysView) layout;
