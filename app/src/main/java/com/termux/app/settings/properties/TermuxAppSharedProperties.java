...
public class TermuxAppSharedProperties extends TermuxSharedProperties {
    ...
    private void setExtraKeys() {
        ...
        try {
            ...
            try {
                mExtraKeysInfo = new ExtraKeysInfo(DeviceUtils.isWatchDevice(mContext) ? TermuxPropertyConstants.DEFAULT_IVALUE_EXTRA_KEYS_WATCH : TermuxPropertyConstants.DEFAULT_IVALUE_EXTRA_KEYS, TermuxPropertyConstants.DEFAULT_IVALUE_EXTRA_KEYS_STYLE, ExtraKeysConstants.CONTROL_CHARS_ALIASES);
